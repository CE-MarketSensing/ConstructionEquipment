...
for i in range(23,26):
    driver.find_element(By.CSS_SELECTOR,f'#container-1237bb0555 > div > div > div > div > div > div.list__list-col > div.list__wrapper > ul > li:nth-child({i}) > a > div.list__item-text > h3').click()
    try:
        article = driver.find_element(By.CSS_SELECTOR, 'body > div.root.responsivegrid > div > div:nth-child(8) > div').text
    except:
        article = driver.find_element(By.CLASS_NAME,"responsivegrid").text
